...
$('#deleteBackground').click(function() {
    ...
    if (selectedImg != '') {
        selectedImg = selectedImg.join(',');
        $.post("actionsdeleteBackground.php", {
            "bgid": selectedImg
        }, function(data) {
            $('#spinnerModal').modal('hide');
...
function proceed_tempDelete() {
    ...
    if (selectedTemp != '') {
        $.post("actionsdeleteTemplate.php", {
...
function gettempcategory() {
    $.ajax({
        type: "GET",
        url: "actionsgettempCategory.php",
        success: function(data) {
...
function getTextcategory() {
    $.ajax({
        type: "post",
        url: "actionsgetTextCategory.php",
        success: function(data) {
...
function getTemplatesName() {
    $.ajax({
        type: "post",
        url: "actionsgetTemplate_name.php",
        success: function(data) {
...
function proceed_tempcatdelete() {
    ...
    $("#spinnerModal").modal('show');
    $.post("actionsdeletetempcategory.php", {
...
function proceed_catdelete() {
    ...
    $("#spinnerModal").modal('show');
    $.post("actionsdeletecategory.php", {
        "categoty": sel_catid
    }, function(data) {
        $('#spinnerModal').modal('hide');
        $('#catimage_container').empty();
...
function proceed_Bgcatdelete() {
    ...
    $("#spinnerModal").modal('show');
    $.post("actionsdeletebgcategory.php", {
...
function proceed_textcatdelete() {
    ...
    $("#spinnerModal").modal('show');
    $.post("actionsdeletetextcategory.php", {
